...
function my_theme_enqueue_styles()
{
    ...
    // Chargement du /css/widgets/bloc-lien-image-widget.css pour notre widget image bloc
    wp_enqueue_style('bloc_lien_image_widget', get_stylesheet_directory_uri() . '/css/widgets/bloc-lien-image-widget.css', array(), filemtime(get_stylesheet_directory() . '/css/widgets/bloc-lien-image-widget.css'));
...
// On créer une class Widget Bloc_Lien_Image_Widget dans un fichier à part pour pas surcharger le functions.php
...
function register_widgets()
{
    ...
    //On enregistre le widget avec la class Bloc_Lien_Image_Widget
...
/* Hook pour ajouter 'Listes des' au titre de la page Archive */
...
/* Hook pour remplacer le titre Outils par Tous les outils */
...
/* Hook pour ajouter un separateur et description sous l'image du produit */
...
/* Hook pour ajouter un bouton qui renvoie sur la description du produit */
...
/* Hook pour ajouter 'Page :'  en bas de pagination */
...
/* HOOKS ACTIONS */
/* Hook pour ajouter un titre en bas de page */
...
<p class="after-loop">
    <?php
            echo do_shortcode('[banniere-titre src="http://localhost:8888/bricotips/wp-content/uploads/2023/02/banniere-image.webp" titre="BricoTips"]');
            ?>
</p>
<?php
    endif;
...
/* Ajout d'un texte de présentation des produits sur la pages */
$shown = false;

...
<main id="apropos">
    <?php echo do_shortcode('[banniere-titre titre="À propos de BricoTips" src="http://localhost:8888/bricotips/wp-content/uploads/2023/02/banniere-image.webp"]') ?>

    <section id="quisuisje">
        <h2>Qui suis-je&nbsp;?</h2>
        <div class="text">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi commodi delectus odit omnis quam
                sequi
                soluta. Amet animi consequatur doloremque et exercitationem, fugit labore nam quo quod rem soluta,
                velit!</p>
            <p>Dolor, optio, quos? Alias, aliquid amet asperiores atque consequuntur cupiditate dolorum mollitia,
                non
                odit porro praesentium quaerat quo rem unde vel? Dolorum error laudantium nobis odio officia optio
                quis
                tempore!</p>
        </div>
        <div class="image">
    ...
    <section id="bricolage">
        ...
        <div class="text">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium at autem debitis earum fugiat
                incidunt laborum omnis saepe. Aperiam culpa earum enim incidunt ipsa molestiae nihil quae quasi
                ratione
                sequi!</p>

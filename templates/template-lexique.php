...
<main id="lexique">
    <?php echo do_shortcode('[banniere-titre titre="Lexique" src="http://localhost:8888/bricotips/wp-content/uploads/2023/02/banniere-image.webp"]') ?>
    <section>
        <!-- Boucle PHP affichant les élémemts du tableau -->
        <?php
